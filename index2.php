...
<?php
			if(isset($_POST['upload']))
			{
				...
				{	$path="id_pics/$img_name";
					move_uploaded_file($img_tmp_name,$path);
					//echo "image is uploaded successfully";
					//echo" Here is image <img src=$path>";
					header("location:index.php?image-file=$path");
				}
			}
		?>
<!DOCTYPE html>
				...
				<small class="text-uppercase">	
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="#recent"> Recent Hits</a></li>
							...
							<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo "Hi ".$_COOKIE['name'];?><span class="caret"></span></a>
