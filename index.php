...
<html lang='en'>
	<head>
		...
		<meta name="google-site-verification" content="j61cHyyiqD9Md2ctIBKnhKbvySQgY6pZp_T6N-ioPIA" />
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
		<meta name="description" content="Every thing about information & technology sector">
		<meta name="keywords" content="SANCHIT KUMAR,SANCHIT DABGOTRA,RECENT HITS,RECENT TECH,HACKER,OS,OPERATING SYSTEM,INNOVATION,RANKINGS,IT RANKING,UPCOMINGS,UPCOMINGS TECHNOLOGY,COMPUTING RECORDS,BENCHMARK,SOFTWARE">
		<!-- jQuery library -->
		...
		<link rel="stylesheet" href="main.css"/>
				<script type="text/javascript">
					...
					{
						//var s='0';
						document.getElementById('subm1').onclick=function(){s='1'};
						var scomment="comment".concat(s);
						var sdate="date".concat(s);
						var scid="cid".concat(s);
						var ssubm="subm".concat(s);
						var comment = document.getElementById(scomment).value;
					  var name = document.getElementById(sdate).value;
					  var c = document.getElementById(scid).value;
					  var subm = document.getElementById(ssubm).value;
					  if(comment && name)
					  {
						$.ajax
						({
						  ...
						  {
							  var cmt='all_comments'.concat(s);
							  $(cmt).empty();
							document.getElementById(cmt).innerHTML=response;
...
?>
	<?php
			echo"<div class='modal fade text-center' id='log_er' role='dialog'>
					<div class='modal-dialog'>
						<div class='modal-content'>
							...
							<div class='modal-body'>
								<h5 style='font-size:20px;margin-bottom:15px;'>You need to login first to add comment...</h5>
								<form class='form-inline' method='post' action=".login($conn)." >
...
<!---------end of the carousel ------------>
		...
		<!-----------RECENT HITS ----->
		<div class="container bg" id="recent">
			<H3 class="slideanim text-center">RECENT HITS</H3>
				...
				<div class="col-sm-4  slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#1"><?php countcomments($conn,'1');?> <span class='caret'></span></button>
						</small>	
					</div>
					
						<div id="r1" class="collapse in"> <!----collapse div -->
								...
								<a href="recent.php" role="button"class="btn btn-success">Read more</a><br/>
						</div>
							<?php
							echo" <div id='1' class='collapse in'>
						<form class='form-inline' method='post' onsubmit='return post(1);'>
								<input type='hidden'id='cid1' name='cid' value='1'/>
								<input type='hidden' id='date1' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment1' name='message1' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment1' name='message1' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm1' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments1'>
							"; getcomments($conn,'1'); echo"
						</div>";
			echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								<button type="button" class="btn btn-default" data-toggle="collapse" data-target="#r2">Description <span class="caret"></span></button>
															<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#2"><?php countcomments($conn,'2');?> <span class='caret'></span></button>

							</small>
					</div>
					
					<div id="r2" class="collapse in"> <!----collapse div -->
					...
					<?php
							echo" <div id='2' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(2);'>
								<input type='hidden'id='cid2' name='cid' value='2'/>
								<input type='hidden' id='date2' name='date' value='".date
								('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment2' name='message' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment2' name='message' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm2' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments2'>
							"; getcomments($conn,'2'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#3"><?php countcomments($conn,'3');?> <span class='caret'></span></button>
						</small>
					</div>
					
					<div id="r3" class="collapse in"> <!----collapse div -->
					...
					<?php
							echo" <div id='3' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(3);'>
								<input type='hidden'id='cid3' name='cid' value='3'/>
								<input type='hidden' id='date3' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment3' name='message' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment3' name='message' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm3' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments3'>
							"; getcomments($conn,'3'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
			...
			-->
			<div class="hr slideanim text-center">
				<hr/>
		...
		<!------------OS------>
		<div >
		<div class="container bg" id="os">
			<h3 class="slideanim text-center">OPERATING SYSTEM GIANTS</h3>
			<div class="row">
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#4"><?php countcomments($conn,'4');?> <span class='caret'></span></button>

							</small>
								
					</div>
					
					<div id="os1" class="collapse in"> <!----collapse div -->
					...
					<?php
							echo" <div id='4' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(4);'>
								<input type='hidden'id='cid4' name='cid' value='4'/>
								<input type='hidden' id='date4' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment4' name='message' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment4' name='message' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm4' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments4'>
							"; getcomments($conn,'4'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#5"><?php countcomments($conn,'5');?> <span class='caret'></span></button>

							</small>
								
					</div>
					
					<div id="os2" class="collapse in"> <!----collapse div -->
					...
					<?php
							echo" <div id='5' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(5);'>
								<input type='hidden'id='cid5' name='cid' value='5'/>
								<input type='hidden' id='date5' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment5' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment5' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm5' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments5'>
							"; getcomments($conn,'5'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#6"><?php countcomments($conn,'6');?> <span class='caret'></span></button>
					
							</small>
					</div>
								<div id="os3" class="collapse in"> <!----collapse div -->
								...
								<?php
							echo" <div id='6' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(6);'>
								<input type='hidden'id='cid6' name='cid' value='6'/>
								<input type='hidden' id='date6' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment6' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment6' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm6' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments6'>
							"; getcomments($conn,'6'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
		...
		<!-------END OS ------>
		<!----------HACKER WORLD ---->
		<div class="container bg" id="hack">
			<h3 class="slideanim text-center">HACKER'S CORNER</h3>
			<div class="row">
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#7"><?php countcomments($conn,'7');?> <span class='caret'></span></button>
					...
					<?php
							echo" <div id='7' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(7);'>
								<input type='hidden'id='cid7' name='cid' value='7'/>
								<input type='hidden' id='date7' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment7' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment7' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm7' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments7'>
							"; getcomments($conn,'7'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#8"><?php countcomments($conn,'8');?> <span class='caret'></span></button>
					...
					<div id="h2" class="collapse in"> <!----collapse div -->
						...
						<?php
							echo" <div id='8' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(8);'>
								<input type='hidden'id='cid8' name='cid' value='8'/>
								<input type='hidden' id='date8' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment8' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment8' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm8' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments8'>
							"; getcomments($conn,'8'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#9"><?php countcomments($conn,'9');?> <span class='caret'></span></button>
					...
					<div id="h3" class="collapse in"> <!----collapse div -->
								...
								<?php
							echo" <div id='9' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(9);'>
								<input type='hidden'id='cid9' name='cid' value='9'/>
								<input type='hidden' id='date9' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment9' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment9' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm9' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments9'>
							"; getcomments($conn,'9'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
		...
		<!--------END OF HACKER WORLD ---->
		<!--------INNOVATIVE PROJECTS ---->
		<div class="container bg" id="innov">
			<h3 class="slideanim text-center">NEW INNOVATION</h3>
			<div class="row">
				<div class="col-sm-4 slideanim">
					<h4>PARROT DISCO</h4>
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#10"><?php countcomments($conn,'10');?> <span class='caret'></span></button>

							</small>
								
					</div>
						<div id="in1" class="collapse in"> <!----collapse div -->
						...
						<?php
							echo" <div id='10' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(10);'>
								<input type='hidden'id='cid10' name='cid' value='10'/>
								<input type='hidden' id='date10' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment10' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment10' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm10' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments10'>
							"; getcomments($conn,'10'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
					...
					<div class="thumbnail text-center">
						...
						<small>
								<button type="button" class="btn btn-default" data-toggle="collapse" data-target="#in2">Description</button>
												<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#11"><?php countcomments($conn,'11');?> <span class='caret'></span></button>
			
							</small>
								
					</div>
					<div id="in2" class="collapse in "> <!----collapse div -->
								...
								<?php
							echo" <div id='11' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(11);'>
								<input type='hidden'id='cid11' name='cid' value='11'/>
								<input type='hidden' id='date11' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment11' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment11' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm11' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments11'>
							"; getcomments($conn,'11'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					...
					<small>
						<button type="button" class="btn btn-default" data-toggle="collapse" data-target="#in3">Description</button>
						<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#12"><?php countcomments($conn,'6');?> <span class='caret'></span></button>
			
							</small>
					</div>
				
					<div id="in3" class='collapse in'> <!----collapse div -->
					...
					<?php
							echo" <div id='12' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(12);'>
								<input type='hidden'id='cid12' name='cid' value='12'/>
								<input type='hidden' id='date12' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment12' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment12' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm12' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments12'>
							"; getcomments($conn,'12'); echo"
						</div>";
						echo"</div>";
						?>
			</div></div>
		...
		<!-----SOFTWARE WORLD ---->
		<div class="container bg" id="soft">
			<h3 class="slideanim text-center">SOFTWARE WORLD</h3>
			<div class="row">
				<div class="col-sm-6 slideanim ">
					...
					<div>
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#13"><?php countcomments($conn,'13');?> <span class='caret'></span></button>
	
							</small>
					</div>
					<div id="s1" class="collapse in text-center"> <!----collapse div -->
									<small>
										<table class="table table-responsive table-striped table-bordered">
										<thead>
											<tr class="slideanim">
								...
								<?php
							echo" <div id='13' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(13);'>
								<input type='hidden'id='cid13' name='cid' value='13'/>
								<input type='hidden' id='date13' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment13' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment13' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm13' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments13'>
							"; getcomments($conn,'13'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
					...
					<div class='text-center'>
						...
						<small>
								<button type="button" style="border:solid 2px #2aa32e;"class="btn btn-default" data-toggle="collapse" data-target="#s2">View top 10 list <span class="caret"></span</button>
															<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#14"><?php countcomments($conn,'14');?> <span class='caret'></span></button>

							</small>
					</div>
						<div id="s2" class="collapse in text-center"> <!----collapse div -->	
								<small>
						...
						<?php
							echo" <div id='14' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(14);'>
								<input type='hidden'id='cid14' name='cid' value='14'/>
								<input type='hidden' id='date14' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment14' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment14' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm14' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments14'>
							"; getcomments($conn,'14'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
		...
		<div class="container text-center bg" id="rank">
			...
			<div class="row">
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail">
						...
						<small>
							...
							<div id="ra1" class="collapse in"> <!----collapse div -->
									<small>
									<table class="table table-responsive table-striped table-bordered">
										<thead>
											<tr class="slideanim">
				...
				<div class="col-sm-4 slideanim">
					...
					<div id="ra3" class="collapse in"> <!----collapse div -->
										<small>
										<table class="table table-responsive table-striped table-bordered">
										<thead>
											<tr class="slideanim">
		...
		<!----END OF RANKINGS --->
		<!------COOMING SOON ---------->
		<div class="container bg" id="upcom">
			<h3 class="slideanim text-center">FUTURE PROJECTS. COMING SOON...</h3>
			<div class="row">
				<div class="col-sm-4 slideanim">
					<div class="thumbnail text-center">
						...
						<img src="images/loom.jpg" data-toggle="tooltip" title="Project Loom" class="img-responsive" alt=""/>
							<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#15"><?php countcomments($conn,'15');?> <span class='caret'></span></button>
	
							</small>
								
					</div>
								<div id="c1" class="collapse in"> <!----collapse div -->
								...
								<?php
							echo" <div id='15' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(15);'>
								<input type='hidden'id='cid15' name='cid' value='15'/>
								<input type='hidden' id='date15' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment15' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment15' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm15' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments15'>
							"; getcomments($conn,'15'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					<div class="thumbnail text-center">
						<h4>3D PRINTED FOOD-3D PRINTING</H4>
							...
							<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#16"><?php countcomments($conn,'16');?> <span class='caret'></span></button>

							</small>
								
					</div>
					<div id="c2" class="collapse in"> <!----collapse div -->
					...
					<?php
							echo" <div id='16' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(16);'>
								<input type='hidden'id='cid16' name='cid' value='16'/>
								<input type='hidden' id='date16' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment16' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment16' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm16' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments16'>
							"; getcomments($conn,'16'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
				<div class="col-sm-4 slideanim">
					<div class="thumbnail text-center">
						...
						<small>
								...
								<button type="button" class="btn btn-default comment" data-toggle="collapse" data-target="#17"><?php countcomments($conn,'17');?> <span class='caret'></span></button>

							</small>
					</div>
							<div id="c3" class="collapse in"> <!----collapse div -->
						...
						<?php
							echo" <div id='17' class='collapse in'>
							<form class='form-inline' method='post' onsubmit='return post(17);'>
								<input type='hidden'id='cid17' name='cid' value='17'/>
								<input type='hidden' id='date17' name='date' value='".date('Y-m-d H:i:s')."'/>";
						echo"	<div class='row'>
									<div class='col-xm-12'> ";
							if(!isset($_COOKIE['email']))
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment17' name='message5' onkeydown='myfunction()' placeholder='Add a comment...'></textarea>";
							else 
								echo"<textarea class='form-control' style='width:92%; resize:none;margin-left:15px;' id='comment17' name='message5' placeholder='Add a comment...'></textarea>";
							echo"</div>
							</div>
								<div class='row'>
								<div class='col-xs-4'>
								<input type='submit' id='subm17' class='btn btn-default form-control' name='sub' value='Submit'/>
								</div>
								<div class='col-xs-8'>
								</div>
								</div>
						...
						echo"
						<div id='all_comments17'>
							"; getcomments($conn,'17'); echo"
						</div>";
						echo"</div>";
						?>
				</div>
