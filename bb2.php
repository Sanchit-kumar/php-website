					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="#recent"> Recent Hits</a></li>
							...
							<?php 
								...
								{
									echo"<li> <button style='margin-top:8px;' type='button' class='btn btn-default' data-toggle='modal' data-target='#log'><span class='glyphicon glyphicon-log-in'></span> LOG IN</a></li>";
								}
								else{
...
<!---------end of the carousel ------------>
		...
		<div class="container text-center bg" id="recent">
			...
			<div class="row slideanim">
				<div class="col-sm-4  slideanim">
					...
					<div id="r1" class="collapse"> <!----collapse div -->
								...
								<a href="recent.html" role="button"class="btn btn-success">Read more</a>
								</div>
				</div>
				<div class="col-sm-4 slideanim">
				...
				<div class="col-sm-4 slideanim">
					...
					<div id="r3" class="collapse"> <!----collapse div -->
										...
										<p>Oracle's commitment to Java and its community remains stronger than ever, as shared recently at JavaOne. Oracle is not ramping Java SE compliance activity or hiring of compliance staff. The licensing model and policies for Java SE have remained unchanged since before the acquisition of Sun Microsystems. It is incorrect to imply that it's easy for users to accidentally use Java SE Advanced features.</p>
											<a href="recent.html" role="button"class="btn btn-success">Read full article.</a>
			...
			<div class="hr slideanim">
				<hr/>
					<a href="recent.html" role="button"class="btn btn-default">Go to full page</a>
				<hr/>
			</div>
		</div>
		<!------------END RECENT HITS --->
			...
			<div class="row">
				<div class="col-sm-4 slideanim">
					...
					<div id="os1" class="collapse"> <!----collapse div -->
										...
										<small>
										<a href="os.html" role="button" class="btn btn-success">Go to full page</a>
									</small>
								</div>
				</div>
				<div class="col-sm-4 slideanim">
			...
			<div class="row">
				<div class="col-sm-4 slideanim">
					...
					<div id="h1" class="collapse"> <!----collapse div -->
										...
										<a href="hacker.html" role="button" class="btn btn-success">Read more</a>
								</div>
				</div>
				<div class="col-sm-4 slideanim">
				...
				<div class="hr slideanim">
					<hr/>
						<a href="hacker.html" role="button" class="btn btn-default">Go to full page</a>
					<hr/>
				</div>
		</div>
		<!--------END OF HACKER WORLD ---->
		...
		<div class="container text-center bg" id="innov">
			...
			<div class="row">
				<div class="col-sm-4 slideanim">
					...
					<div class="thumbnail">
						...
						<div id="in1"> <!--class="collapse"> <!----collapse div -->
										...
										<small>
										<a href="innov.html" role="button" class="btn btn-success">Go to full page to continue..</a>
									</small>
								</div>
				</div>
				<div class="col-sm-4 slideanim">
				...
				<div class="hr slideanim">
				<hr/>
					<a href="innov.html" role="button"class="btn btn-primary">Switch to full innovation page</a>
				<hr/>
			</div>
		</div>	
		...
		<div class="container text-center bg" id="bench">
			...
			<div class="hr slideanim">
				<hr/>
					<a href="bench.html" role="button"class="btn btn-default">View More Benchmarks</a>
				<hr/>
			</div>
		</div>
		...
		<div class="container text-center bg" id="soft">
			...
			<div class="row">
				...
				<div class="hr slideanim">
				<hr/>
					<a href="soft.html" role="button"class="btn btn-success">Go to full page</a>
				<hr/>
			</div>
		</div>
		...
		<div class="container text-center bg" id="rank">
			...
			<div class="row">
				...
				<div class="hr slideanim">
				<hr/>
					<a href="rank.html" role="button"class="btn btn-default">See more ranking-go to rankings page</a>
				<hr/>
			</div>
		</div>
		<!----END OF RANKINGS --->
		...
		<div class="container text-center bg" id="upcom">
			...
			<div class="row">
						...
						<img src="images/loom.jpg" data-toggle="tooltip" title="Project Loom" class="img-responsive" alt=""/>
							<small>
								...
								<div id="c1" class="collapse"> <!----collapse div -->
									...
									<small>
										<a href="upcom.html" role="button" class="btn btn-success">Read More...</a>
									</small>
								</div>
				</div>
				<div class="col-sm-4 slideanim">
				...
				<div class="hr slideanim">
				<hr/>
					<a href="upcom.html" role="button"class="btn btn-success">Go to full page</a>
				<hr/>
			</div>
		</div>
		<!-------END OF COOMING SOON--->
