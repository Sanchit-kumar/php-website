...
<html lang='en'>
	...
	<?php
	echo"
	<div class='modal fade text-center' id='log' role='dialog'>
				...
				<small class="text-uppercase">	
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="#recent"> Recent Hits</a></li>
							...
							<?php echo"<li><button type='button' class='btn btn-default' data-toggle='modal' data-target='#log'>DI</button>

							</li> ";
							?><!--code for changin the name------>
